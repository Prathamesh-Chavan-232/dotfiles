vim.api.nvim_create_autocmd("BufReadPost", {
	group = vim.api.nvim_create_augroup("gmr_jump_to_the_last_known_cursor_position", { clear = true }),
	pattern = { "*" },
...
vim.api.nvim_create_autocmd("VimLeave", {
	group = vim.api.nvim_create_augroup("gmr_restore_cursor_shape_on_exit", { clear = true }),
	pattern = { "*" },
...
vim.api.nvim_create_autocmd("FileType", {
	group = vim.api.nvim_create_augroup("gmr_json_conceal_level_0", { clear = true }),
...
vim.api.nvim_create_autocmd("TextYankPost", {
	group = vim.api.nvim_create_augroup("gmr_highlight_on_yank", { clear = true }),
...
vim.api.nvim_create_autocmd("VimResized", {
	group = vim.api.nvim_create_augroup("gmr_consistent_size_buffers", { clear = true }),
...
vim.api.nvim_create_autocmd("FileType", {
	group = vim.api.nvim_create_augroup("gmr_disable_indentscope_filetypes", { clear = true }),
