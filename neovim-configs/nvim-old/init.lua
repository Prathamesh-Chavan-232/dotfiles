...
-- editor features
require "falconcodes/plugins/impatient"
require "falconcodes/plugins/whichkey"
require "falconcodes/plugins/comment"
require "falconcodes/plugins/undotree"         -- creates undo trees
require "falconcodes/plugins/autopairs"        -- auto close brackets
require "falconcodes/plugins/project"
require "falconcodes/plugins/alpha"
...
require "falconcodes/plugins/cmp"
require "falconcodes/plugins/lsp"
